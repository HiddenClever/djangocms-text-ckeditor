			...
			contents: [
              ...
              ////////////////////////////// Patched By Stephen //////////////////////////////////
							...
							items: [
								...
								[ editor.lang.common.borderstyleHidden, 'hidden' ],
								...
								[ editor.lang.common.borderstyleInitial, 'initial' ],
								[ editor.lang.common.borderstyleInherit, 'inherit' ]
								],
							setup: function( selectedTable ) {
					  ...
					  ////////////////////////////// Patched By Stephen //////////////////////////////////
						  ...
						  ////////////////////////////// Patched By Stephen //////////////////////////////////
					    {
							...
							setup: function( selectedTable ) {
								if(selectedTable.getStyle('border-color')){
								  this.setValue(selectedTable.getStyle('border-color'));
								}
								else if(selectedTable.getAttribute('bordercolor')){
								  this.setValue(selectedTable.getAttribute('bordercolor'));
							...
							commit: function( data, selectedTable ) {
					      if(this.getValue()){
						      selectedTable.setStyle('border-color', this.getValue());  
					      }
					      else{
